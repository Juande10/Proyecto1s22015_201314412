<%-- 
    Document   : AdminEsClave
    Created on : 28/08/2015, 03:53:26 PM
    Author     : Juande
--%>
    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="AdminEsClave.jsp">Estaciones Clave</a></li>
    ...
    <div class="content_resize"> <img src="images/hbg_img.jpg" width="948" height="295" alt="" class="hbg_img" /></a>
      ...
      <div class="mainbar">
        <div class="article">
          ...
          <p> En esta pagina se puede administrar la informacion de las estaciones clave:           
               <p> - Agregar</p>
               <p> - Modificar</p>
               <p> - Eliminar</p>
                ...
                <select id="tipo" name="tipo" onChange="mostrar(this.value);">
                    <option value="Crear">Crear Estacion Clave</option>
                    <option value="Modificar">Modificar Estacion Clave</option>
                    <option value="Eliminar">Eliminar Estacion Clave</option>
                 </select>
                </form>
                ...
                <div id="Modificar" style="display: none;">
                    ...
                    <form action="AdminEsClave.jsp" method="post" >
                        ...
                        <select name="EstacionClaveModificar">  
                        ...
                        <input type="password" name="contramodificar" /></p>
                         ...
                         <input type="submit" value="Modificar"/>
                             <%-- start web service invocation --%><hr/>
                            <%
                                if(request.getParameter("EstacionClaveModificar") != null){
                                    String seleccionado = request.getParameter("EstacionClaveModificar");
                                    if(seleccionado.equals("Seleccione")){
                                        ...
                                        try {
                                            ...
                                            webservice.WS port = service.getWSPort();
                                             // TODO initialize WS operation arguments here
                                            java.lang.String id = request.getParameter("EstacionClaveModificar");
                                            ...
                                            if(id.equals("") || idnuevo.equals("") || nombre.equals("") || contrasena.equals("") || id.equals(null) ||idnuevo.equals(null)|| nombre.equals(null)|| contrasena.equals(null)){
                                                ...
                                                boolean result = port.modificarEsClave(id, idnuevo, nombre, contrasena);
                                                if(result == true){
